{{-- Hero de réservation (étape 1) — formulaire de trajet réel, câblé à
     l'autocomplétion (/api/v1/autocomplete), aux pickers date/heure et à la
     soumission du tunnel (route booking.step1). Partagé entre la page
     /reservation (booking/form.blade.php) et l'accueil du site vitrine
     (marketing/home.blade.php) : un seul formulaire, un seul comportement.

     Requiert $prefill (clés : pickup_address, dropoff_address, ride_date,
     ride_time, pickup_place_id, dropoff_place_id). --}}
